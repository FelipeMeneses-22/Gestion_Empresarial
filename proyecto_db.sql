...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-04-2026 a las 01:10:57
...
CREATE TABLE `movimientos_inventario` (
  ...
  `cantidad_mov` int(11) DEFAULT NULL,
...
--
ALTER TABLE `comprobante`
  ADD CONSTRAINT `comprobante_ibfk_1` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`);
